...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			LogPrint.Print("action", "ACTION_DOWN~~~~~~~~~~~~~");
			/*
		...
		case MotionEvent.ACTION_MOVE:
			LogPrint.Print("action", "ACTION_MOVE~~~~~~~~~~~~~");
			...
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				...
				LogPrint.Print("deltaX", "deltaX = " + deltaX);
				mLastMotionX = x;
		...
		case MotionEvent.ACTION_UP:
			LogPrint.Print("action", "ACTION_UP~~~~~~~~~~~~~");
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				...
				if (velocityX > SNAP_VELOCITY && mCurrentScreen > 0) {
					...
					LogPrint.Print("lmn", "snapToDestination--");
					snapToDestination();
				}
	...
	private void snapToScreen(int whichScreen) {
		LogPrint.Print("lmn", "whichScreen = " + whichScreen);
		LogPrint.Print("lmn", "mCurrentScreen = " + mCurrentScreen);
	...
	private void postViewSwitched(int direction) {
		LogPrint.Print("lmn", "direction = " + direction);
		LogPrint.Print("lmn", "mCurrentAdapterIndex = " + mCurrentAdapterIndex);
		LogPrint.Print("lmn", "mAdapter.getCount() = " + mAdapter.getCount());
		if (next) {
			LogPrint.Print("lmn", "next ===== ");
		}
		if (direction == 0 && next
	...
	private void logBuffer() {
		LogPrint.Print("viewflow", "Size of mLoadedViews: " + mLoadedViews.size()
				+ "X: " + mScroller.getCurrX() + ", Y: " + mScroller.getCurrY());
		LogPrint.Print("viewflow", "IndexInAdapter: " + mCurrentAdapterIndex
