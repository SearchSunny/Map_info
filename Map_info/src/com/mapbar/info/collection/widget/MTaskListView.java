 ...
 *
 */
public class MTaskListView extends ListView implements OnScrollListener {
	...
	private TaskListViewListener mListViewListener;
	 ...
	 * @param context
	 */
	public MTaskListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public MTaskListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public MTaskListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setTaskListViewListener(TaskListViewListener l) {
		mListViewListener = l;
	}
